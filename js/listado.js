...
Listado.prototype.buscarRestaurante = function (id) {
    ...
    return (restaurant == undefined) ? "No se ha encontrado ningún restaurant" : restaurant;
}
...
Listado.prototype.obtenerCiudades = function () {
    ...
    ciudades = eliminarRepetidos(ciudades);
...
Listado.prototype.obtenerHorarios = function () {
    ...
    var arraysHorarios = this.restaurantes.map(restaurante => restaurante.horarios);

    //En este arreglo vamos a poner todos los horarios, uno por uno
    var horarios = [];
    arraysHorarios.forEach(function (array) {
        array.forEach(function (horario) {
